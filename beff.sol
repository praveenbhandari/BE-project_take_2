...
contract mini {
    ...
    struct borower {
        ...
        // mapping(uint => app_loans )loansss;
        // uint256 loan_amountt;
        // string l_purpose;
        uint256 received_ammount;
        // uint256 roi;
...
function user(
    ...
    function approved_loan_ids(uint256 lo_amount,uint256 lo_purpose,uint termmm,string memory roiii,uint creditscore,uint creditworthiness)public{
        ...
        // borowerInfo[a].loansss[b_num];
    //    borowerInfo[a].loansss.loan_ids.push(b_num);
    //     borowerInfo[a].loansss.loan_idd=block.number;
    //     borowerInfo[a].loansss.borrower_ac_address=a;
    //     borowerInfo[a].loansss.roii=roiii;
    //     borowerInfo[a].loansss.loan_amountt=lo_amount;
    ...
    //     borowerInfo[a].creditscore=creditscore;
        ...
        borowerInfo[a].loansss[b_num];
        borowerInfo[a].loansss[b_num].loan_ids.push(b_num);
        borowerInfo[a].loansss[b_num].loan_idd=block.number;
        borowerInfo[a].loansss[b_num].borrower_ac_address=a;
        borowerInfo[a].loansss[b_num].roii=roiii;
        borowerInfo[a].loansss[b_num].loan_amountt=lo_amount;
        borowerInfo[a].loansss[b_num].l_purpose=lo_purpose;
        borowerInfo[a].loansss[b_num].term=termmm;
        borowerInfo[a].creditworthiness=creditworthiness;
        borowerInfo[a].creditscore=creditscore;
    ...
    function get(uint256 b_num)public view returns(uint256[] memory){
        // return  borowerInfo[msg.sender].loansss.loan_ids;
        return  borowerInfo[msg.sender].loansss[b_num].loan_ids;
    }
    function gettt(uint256 b_num)public view returns(app_loans[] memory){
        // return  borowerInfo[msg.sender].loansss.loan_ids;
        return  borowerInfo[msg.sender].loansss;
    }
 ...
 function get_loan(uint256 b_num)public view returns(uint256 ,address,string memory,uint256,uint256,uint256,address){
        // borowerInfo[msg.sender].loansss.loan_ids.push(block.number);
        // return (borowerInfo[msg.sender].loansss.loan_idd,
        // borowerInfo[msg.sender].loansss.borrower_ac_address,
        // borowerInfo[msg.sender].loansss.roii,
        ...
        // borowerInfo[msg.sender].loansss.lender_acc
        // );
        // return (borowerInfo[msg.sender].loansss[b_num].loan_idd,
        // borowerInfo[msg.sender].loansss[b_num].borrower_ac_address,
        // borowerInfo[msg.sender].loansss[b_num].roii,
        // borowerInfo[msg.sender].loansss[b_num].loan_amountt,
        // borowerInfo[msg.sender].loansss[b_num].l_purpose,
        // borowerInfo[msg.sender].loansss[b_num].term,
        // borowerInfo[msg.sender].loansss[b_num].lender_acc
        // );
    } 
...
//   }
    ...
    function sendmoneyy(address payable to,uint256 b_num)
        public
        payable
        returns (uint256)
    {
        ...
        lenderInfo[msg.sender].bor.amount=msg.value;
        // borowerInfo[to].loansss.lender_acc=msg.sender;
        // borowerInfo[to].loansss.loan_amountt=msg.value;
        // borowerInfo[to].received_ammount=borowerInfo[to].loansss.loan_amountt-msg.value;
       
       borowerInfo[to].loansss[b_num].lender_acc=msg.sender;
        borowerInfo[to].loansss[b_num].loan_amountt=msg.value;
        borowerInfo[to].received_ammount=borowerInfo[to].loansss[b_num].loan_amountt-msg.value;
